...
(function() {
  ...
  function ParseFile(file) {
    Output(
      ...
      '<h4><a href="javascript:void(0)"><img src="img/xls.svg" alt="form_uploadcopy" class="img-responsive"></a><span>30-11-2018 Wendy Jansen</span>' +
        file.name +
  ...
  // initialize
  function Init() {
    var fileselect = $id("fileselect4"),
      filedrag = $id("filedrag4"),
